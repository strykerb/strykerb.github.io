...
class Vector3 {
  ...
  static cross(other1, other2) {
      ...
      // Calculate X dimension of cross product
      let v3_x = v1[1]*v2[2]-v1[2]*v2[1];

      // Calculate Y dimension of cross product
      let v3_y = -(v1[0]*v2[2]-v1[2]*v2[0]);

      // Calculate Z dimension of cross product
      let v3_z = v1[0]*v2[1]-v1[1]*v2[0];

      // Instantiate cross product vector.
      let v3 = new Vector3([v3_x, v3_y, v3_z]);
      return v3;
  }
  ...
  magnitude() {
      // Insert your code here.
      let v1 = this.elements;
      let m = Math.sqrt(v1[0]*v1[0] + v1[1]*v1[1] + v1[2]*v1[2]); // Calculate this vector's magnitude.
      return m;
  };
  ...
  normalize() {
      // Insert your code here.
      //let v1 = this.elements;
      let v1_m = this.magnitude();
      //let v1_m = Math.sqrt(v1[0]*v1[0] + v1[1]*v1[1] + v1[2]*v1[2]);  // Magnitude of vector
      this.div(v1_m);                 // Divide vector by its magnitude to normalize
      return this;
  };
}
